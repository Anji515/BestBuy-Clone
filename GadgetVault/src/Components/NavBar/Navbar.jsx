            ...
            <div id="main">
                ...
                <img class="other" src="data:image/svg+xml;base64," alt=""/>
                    ...
                    <input id="search-nav" type="text" placeholder="Search Best Buy"/>
                        ...
                        <img class="other" src="" alt="" />
                        <p class="other" >Aiea</p>
                        <img src="" alt=""/>
                            <p>Cart</p>
                        </div>
                        <div id="buttons">
                            ...
                            <div>
                                <div class="dropdown1">
                                    <button onclick="myFunction1()" class="dropbtn1">Account</button>
